...
def display_tiles():
    ...
    # Layout the display
    wsi_tile, cpu_tile, gpu_tile, perf_tile = st.columns(4)
    with wsi_tile:
        display_single_tile_scaled(cpu_tile_np, "Reference Tile")

    with cpu_tile:
        display_single_tile_scaled(transformed_cpu_tile_np, "Transformed Tile (CPU)")

    with gpu_tile:
        display_single_tile_scaled(transformed_gpu_tile_np, "Transformed Tile (GPU)")
