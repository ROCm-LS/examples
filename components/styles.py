...
<div class="powered-by-footer">
  <strong><u><small>Powered By</small></u></strong>
  <br>
  <small>
...
<div class="metadata-tab">
    ...
    <strong>Image file size:</strong> {img_size}<br>
    <strong>Image width (phys.):</strong> {img_width}<br>
    <strong>Image height (phys.):</strong> {img_height}<br>
    <strong>Image device:</strong> {device}<br>
    <strong>Pixel type:</strong> {px_type}<br>
    <strong>No. of dimensions [channels]:</strong> {dims}<br>
</div>
"""
